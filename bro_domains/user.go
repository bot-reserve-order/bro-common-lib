...
type User struct {
	...
	CharterEndDate     time.Time        `json:"charter_end_date" gorm:"column:charter_end_date"`
	NotiToGroupEndDate time.Time        `json:"noti_to_group_end_date" gorm:"column:noti_to_group_end_date"`
	CreatedAt          time.Time
	UpdatedAt          time.Time
}
